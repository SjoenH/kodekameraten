webpackJsonp([0],Array(460).concat([
/* 460 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__program__ = __webpack_require__(599);
...
var ProgramPageModule = (function () {
...
ProgramPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [__WEBPACK_IMPORTED_MODULE_2__program__["a" /* ProgramPage */]],
        imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__program__["a" /* ProgramPage */])]
    })
], ProgramPageModule);
...
var ProgramPage = (function () {
    function ProgramPage(navCtrl, navParams, storage, http, modalCtr, acp, cntProvider) {
        var _this = this;
        ...
        this.posts = [];
        this.user = {};
        __WEBPACK_IMPORTED_MODULE_4_moment___default.a.locale('nb');
    ...
    ProgramPage.prototype.formatDate = function (dateobj) {
        return __WEBPACK_IMPORTED_MODULE_4_moment___default()(dateobj).format('DD/MM HH:mm');
    };
    ProgramPage.prototype.formatOnlyTime = function (dateobj) {
        return __WEBPACK_IMPORTED_MODULE_4_moment___default()(dateobj).format('HH:mm');
    };
    ProgramPage.prototype.chooseArrangement = function () {
        var _this = this;
        var modal = this.modalCtr.create('HomePage');
        modal.onDidDismiss(function () {
            _this.refreshContentData();
        });
        modal.present();
    };
    ProgramPage.prototype.showSettings = function () {
        var _this = this;
    ...
    ProgramPage.prototype.inTheFuture = function (fromtime) {
        return (Date.parse(fromtime) > Date.now());
    };
    ProgramPage.prototype.newEvent = function () {
        var _this = this;
        var eventData = {
        ...
        var modal = this.modalCtr.create('EventCreatorPage', { eventData: eventData });
        modal.onDidDismiss(function (newEventData) {
            if (newEventData) {
                _this.cntProvider.postEvent(newEventData);
                _this.refreshContentData();
            }
        });
        modal.present();
    };
    ProgramPage.prototype.itemSelected = function (eventData) {
        var _this = this;
    ...
    ProgramPage.prototype.scrollTo = function (element_id) {
        ...
        if (el) {
            ...
            console.log("AUTOSCROLL: No matching element " + element_id);
            return false;
        }
    };
    ProgramPage.prototype.eventIsCurrentlyActive = function (event) {
        var nowDate = Date.now();
        var ft = Date.parse(event.fromTime);
        var tt = Date.parse(event.toTime);
        return ft <= nowDate && nowDate <= tt;
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["e" /* Content */]),
...
ProgramPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["q" /* NavController */],
        ...
        __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["p" /* ModalController */],
