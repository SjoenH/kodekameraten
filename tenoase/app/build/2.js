webpackJsonp([2],Array(455).concat([
/* 455 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__news_detail__ = __webpack_require__(594);
...
NewsDetailPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [__WEBPACK_IMPORTED_MODULE_2__news_detail__["a" /* NewsDetailPage */]],
        imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__news_detail__["a" /* NewsDetailPage */]), __WEBPACK_IMPORTED_MODULE_3_ionic_img_viewer__["b" /* IonicImageViewerModule */]]
    })
...
var NewsDetailPage = (function () {
    function NewsDetailPage(navCtrl, navParams, viewCtrl, modalCtr, http, imageViewerCtrl, acp, cntProvider, storage) {
        ...
        this.data = navParams.get('postData');
        this.user = this.acp.getUser();
        this.data = this.navParams.get('postData');
    }
    ...
    NewsDetailPage.prototype.close = function () {
        this.viewCtrl.dismiss();
    };
    NewsDetailPage.prototype.onClick = function (imageToView) {
        var viewer = this.imageViewerCtrl.create(imageToView);
        viewer.present();
    };
    NewsDetailPage.prototype.edit = function () {
        var _this = this;
        var modal = this.modalCtr.create('MessageCreatorPage', {
            postData: this.data
        });
        modal.onDidDismiss(function (updatedData) {
            ...
            if (updatedData) {
                if (updatedData.delete === true) {
                    _this.cntProvider.deleteMessage(updatedData);
                    // .then(() => {
                    //   this.close();
                    // });
                    ...
                    _this.cntProvider.updateMessage(updatedData);
                    // .then((res) => {
                    //   console.log(res);
                    // });
                }
    ...
    NewsDetailPage.prototype.dateFromNow = function (date) {
        // return date.getDay;
        return __WEBPACK_IMPORTED_MODULE_3_moment__(date, 'YYYYMMDD').fromNow();
    };
    NewsDetailPage.prototype.formatDate = function (dateobj) {
        return __WEBPACK_IMPORTED_MODULE_3_moment__(dateobj).format('DD/MM HH:mm');
    };
    NewsDetailPage.prototype.formatOnlyTime = function (dateobj) {
        return __WEBPACK_IMPORTED_MODULE_3_moment__(dateobj).format('HH:mm');
    };
    NewsDetailPage.prototype.momentFromNow = function (dateobj) {
        return __WEBPACK_IMPORTED_MODULE_3_moment__(dateobj).fromNow();
    };
    NewsDetailPage.prototype.getSeminars = function () {
        var _this = this;
        this.cntProvider
            .getMessagesForArrangementWithCategory(this.data.arrangement, this.data.refMessageCategory)
            .then(function (posts) {
            _this.seminars = [];
    ...
    NewsDetailPage.prototype.getEvents = function () {
        var _this = this;
        this.cntProvider
            .getEventsForArrangementWithCategory(this.data.arrangement, this.data.refEventCategory)
            .then(function (posts) {
            _this.events = [];
            for (var key in posts) {
                if (posts.hasOwnProperty(key)) {
    ...
    NewsDetailPage.prototype.getTeam = function () {
        var _this = this;
    ...
    NewsDetailPage.prototype.messageSelected = function (postData) {
        var modal = this.modalCtr.create('NewsDetailPage', { postData: postData });
        modal.onDidDismiss(function (something) {
            // this.getConcerts();
            // Do something?
        });
        modal.present();
    };
    NewsDetailPage.prototype.eventSelected = function (eventData) {
    ...
    NewsDetailPage.prototype.personSelected = function (personData) {
