...
var InfoPage = (function () {
    function InfoPage(navCtrl, navParams, modalCtr, acp, cntProvider, storage) {
        ...
        this.posts = [];
        this.user = {};
        this.arrangement = 'TenOase';
        __WEBPACK_IMPORTED_MODULE_2_moment__["locale"]('nb');
        this.acp.getArrangement().then(function (a) {
            _this.arrangement = a;
        });
    }
