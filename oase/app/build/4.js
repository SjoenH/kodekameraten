webpackJsonp([4],Array(450).concat([
/* 450 */
...
HomePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',template:/*ion-inline-start:"/Users/henry/Documents/GitHub/Oase/Oase-App/src/pages/home/home.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-buttons>\n      <button ion-button padding (click)="close()">\n        <ion-icon name="arrow-back"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n<ion-content class="bg-img" padding>\n  <ion-card>\n    <ion-card-header>\n      <h1>Oase 2018</h1>\n    </ion-card-header>\n    <ion-card-content>\n      If app is showing wrong track by any chance... you may try changing it here. No promises\n    </ion-card-content>\n  </ion-card>\n  <ion-card *ngFor="let arrangement of arrangements">\n    <ion-item tappable (click)=\'clickHandler(arrangement.title)\'>\n      <ion-thumbnail item-end>\n        <img src={{arrangement.imgURL}}/>\n      </ion-thumbnail>\n      <h1>\n        {{arrangement.title}}\n      </h1>\n      <span>{{momentFromNow(arrangement.fromTime)}}</span>\n      <p>Fra: {{formatDate(arrangement.fromTime)}}</p>\n      <p>Til: {{formatDate(arrangement.toTime)}}</p>\n    </ion-item>\n  </ion-card>\n  <!-- <ion-card>\n    <button ion-button (click)="showTutorial()" full>Vis Tutorial</button>\n  </ion-card>\n  <ion-card>\n    <button ion-button color="boring" (click)="gotoUserPage()" full>Min side</button>\n  </ion-card>\n  <ion-card>\n    <button ion-button color="boring" (click)="login()" full>Login/Register</button>\n  </ion-card>\n  <ion-card *ngIf="user.uid" style="text-align: center">\n    <a href="mailto:henryskorpe@gmail.com&subject=OASE-APP: Her er min BrukerID &body={{user.uid}}">\n      <button tappable ion-button>\n        {{user.uid}}\n      </button>\n    </a>\n    <p>{{user.admin}}</p>\n  </ion-card> -->\n</ion-content>'/*ion-inline-end:"/Users/henry/Documents/GitHub/Oase/Oase-App/src/pages/home/home.html"*/
    }),
